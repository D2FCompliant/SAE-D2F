/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eb18794cfd40f65969872434c3f6cf43)
// Runtime types generated with workerd@1.20260921.1 2026-09-23 nodejs_compat
interface __BaseEnv_Env {
	ARCHIVE_OBJECTS: R2Bucket;
	DB: D1Database;
	APP_VERSION: "0.3.1";
	...
	STORAGE_IMMUTABILITY: "retention-locked" | "application-only";
	TIMESTAMP_PROVIDER: "internal-dev";
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		EVIDENCE_SCHEMA_VERSION: "1.0.0";
		MAX_ARCHIVE_BYTES: "20971520";
		STORAGE_IMMUTABILITY: "retention-locked";
		TIMESTAMP_PROVIDER: "internal-dev";
	}
	interface TestEnv {
		ARCHIVE_OBJECTS: R2Bucket;
		...
		EVIDENCE_SCHEMA_VERSION: "1.0.0";
		MAX_ARCHIVE_BYTES: "20971520";
		STORAGE_IMMUTABILITY: "application-only";
		TIMESTAMP_PROVIDER: "internal-dev";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_VERSION" | "GIT_COMMIT" | "ENVIRONMENT" | "EVIDENCE_SCHEMA_VERSION" | "MAX_ARCHIVE_BYTES" | "STORAGE_IMMUTABILITY" | "TIMESTAMP_PROVIDER">> {}
}
